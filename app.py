...
# ===========================================================================
    ...
    sub_page_taken = st.radio(
        "Onderdeel", ["📋 Lijst", "🗓️ Agenda"], horizontal=True, label_visibility="collapsed",
    )
    st.divider()

    if sub_page_taken == "📋 Lijst":
...
# ===========================================================================
    ...
    if sub_page == "📈 Pipeline & Inkomsten":
